...
export interface EnzymeDetail {
  ...
  indications: string[];
  presentation: string;
  /** Nome do produto exatamente como consta no registro ANVISA. */
  anvisaProduct: string;
  /** Nº do processo ANVISA. */
...
export const enzymesData: EnzymeDetail[] = [
  {
    ...
    anvisaProduct: "PBSerum SLIM+ Professional",
    anvisaRegistration: "25351.022708/2021-03"
  },
  {
    slug: "smooth-plus",
    name: "Smooth+",
    ...
    anvisaRegistration: "25351.022816/2021-78",
    patented: true
  },
  {
    slug: "drain-plus",
    ...
    anvisaRegistration: "25351.022809/2021-76"
  }
];
