        ...
        <div className="space-y-8">
          ...
          <div className="hidden md:grid md:grid-cols-2 gap-8 items-stretch">
            ...
            <div className="relative flex flex-col rounded-3xl border-2 border-accent/50 bg-panel p-7 sm:p-8 shadow-2xl overflow-hidden transition-all hover:border-accent">
              ...
              {/* Column Header Badge */}
              <div className="relative z-10 mb-8 border-b border-accent/25 pb-5 flex items-center justify-between">
                <div>
                  <span className="inline-block rounded-full bg-accent px-3 py-1 font-mono text-[11px] font-bold text-accent-fg uppercase tracking-wider mb-2">
              ...
              <div className="relative z-10 space-y-6 flex-1">
                {ENZYME_COMPARISON.map((row) => (
                  <div
                    key={row.attribute}
                    className="rounded-xl border border-accent/20 bg-accent/8 p-4 transition-colors hover:bg-accent/12"
                  >
                    <div className="flex items-center gap-2 font-mono text-xs font-bold text-accent uppercase tracking-wider mb-1.5">
            ...
            {/* PILLAR 2: Bioregenerativos Tradicionais (Muted Neutral Column) */}
              ...
              <div className="relative z-10 mb-8 border-b border-on-panel/10 pb-5 flex items-center justify-between">
                <div>
                  ...
                  <h4 className="font-display text-2xl font-semibold text-on-panel/75 flex items-center gap-2">
                    ...
                    <span>Bioregenerativos Tradicionais</span>
                  </h4>
          ...
          <div className="space-y-6 md:hidden">
            {ENZYME_COMPARISON.map((row) => (
              <div
                key={row.attribute}
                className="rounded-2xl border border-on-panel/14 bg-panel p-5 space-y-4 shadow-lg"
              >
                {/* Attribute Title */}
                <div className="border-b border-on-panel/12 pb-2.5">
                  <span className="font-mono text-[10.5px] font-bold text-accent uppercase tracking-wider block mb-0.5">
                    Atributo Clínico
                  </span>
