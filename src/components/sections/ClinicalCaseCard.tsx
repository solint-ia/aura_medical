  ...
  return (
    <article className="rounded-2xl border border-content/12 bg-card p-5 sm:p-7 shadow-sm transition-all hover:border-[#C59D3F]/40 hover:shadow-md">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        {/* Before Image */}
        <figure className="relative overflow-hidden rounded-xl border border-content/10 bg-[#0D1B2A]">
          ...
          {/* Label Badge */}
          <figcaption className="pointer-events-none absolute bottom-3 left-3 rounded-md border border-white/10 bg-[#0D1B2A]/85 px-3 py-1 font-mono text-[10.5px] font-semibold tracking-[0.12em] text-[#F6F3EC] uppercase shadow-md backdrop-blur-xs">
            Antes
          </figcaption>
        </figure>

        {/* After Image */}
        <figure className="relative overflow-hidden rounded-xl border border-[#C59D3F]/30 bg-[#0D1B2A]">
          <div className="relative aspect-[4/3] w-full overflow-hidden">
            <Image
          ...
          {/* Label Badge */}
          <figcaption className="pointer-events-none absolute bottom-3 left-3 rounded-md bg-[#C59D3F] px-3 py-1 font-mono text-[10.5px] font-bold tracking-[0.12em] text-[#0D1B2A] uppercase shadow-md backdrop-blur-xs">
            Depois
          </figcaption>
        </figure>
      </div>
