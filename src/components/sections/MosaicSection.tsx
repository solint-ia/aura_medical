...
export function MosaicSection() {
  return (
    <section
      ...
      className="relative overflow-hidden bg-canvas px-[clamp(20px,4vw,56px)] pt-4 pb-16 md:pt-6 md:pb-24"
    >
      {/* Task 1: Editorial Typography Anchor */}
      ...
      {/* Task 2 & Task 3: Refined Layout, Backdrop Glow, and Scale */}
      <div className="relative mx-auto w-full max-w-7xl">
        {/* Task 3: Subtle Backdrop Glow */}
        <div
          aria-hidden="true"
        ...
        {/* Task 2: Image with 3D drop shadow matching hexagon contours */}
        <Image
